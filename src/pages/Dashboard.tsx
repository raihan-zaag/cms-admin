    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Welcome back, {user?.name || user?.email}! Here's an overview of your CMS.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Latest changes to your CMS content
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Image uploaded to media library</p>
